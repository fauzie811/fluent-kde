...
namespace Fluent
{
    ...
    class Style: public ParentStyleClass
    {
        ...
        QSize menuSizeFromContents( const QStyleOption*, const QSize&, const QWidget* ) const;
        ...
        */
        ...
        //* tabbar data
        FluentPrivate::TabBarData* _tabBarData = nullptr;
