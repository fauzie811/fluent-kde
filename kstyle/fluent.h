...
Q_DECLARE_OPERATORS_FOR_FLAGS( Fluent::AnimationModes )
Q_DECLARE_OPERATORS_FOR_FLAGS( Fluent::Corners )
Q_DECLARE_OPERATORS_FOR_FLAGS( Fluent::Sides )
