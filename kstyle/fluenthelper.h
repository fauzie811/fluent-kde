#ifndef fluent_helper_h
#define fluent_helper_h
...
namespace Fluent
{
    ...
    //* fluent style helper class.
    /** contains utility functions used at multiple places in both fluent style and fluent window decoration */
    class Helper
    {
        public:
        ...
        //* tab frame outline color
        QColor frameTabOutlineColor( const QPalette& ) const;
        ...
        //* slider handle
        void renderSliderHandle( QPainter*, const QRect&, const QColor&, const QColor& shadow, bool sunken ) const;
