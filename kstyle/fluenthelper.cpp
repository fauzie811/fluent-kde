...
#if FLUENT_HAVE_X11 && QT_VERSION < 0x050000
...
namespace Fluent
{
    ...
    QColor Helper::frameOutlineColor( const QPalette& palette, bool mouseOver, bool hasFocus, qreal opacity, AnimationMode mode ) const
    {
        ...
        const QColor hover( KColorUtils::mix( palette.color( QPalette::Window ), palette.color( QPalette::WindowText ), 0.35 ) );
    ...
    //____________________________________________________________________
    QColor Helper::frameTabOutlineColor( const QPalette& palette ) const
    {

        QColor outline( KColorUtils::mix( palette.color( QPalette::Window ), palette.color( QPalette::WindowText ), 0.15 ) );
    ...
    QColor Helper::buttonBackgroundColor( const QPalette& palette, bool mouseOver, bool hasFocus, bool sunken, qreal opacity, AnimationMode mode ) const
    {
        ...
        QColor background( sunken ?
            KColorUtils::mix( palette.color( QPalette::Button ), palette.color( QPalette::ButtonText ), 0.1 ):
    ...
    QColor Helper::toolButtonColor( const QPalette& palette, bool mouseOver, bool hasFocus, bool sunken, qreal opacity, AnimationMode mode ) const
    {
        ...
        const QColor sunkenColor = KColorUtils::mix( palette.color( QPalette::Button ), palette.color( QPalette::ButtonText ), 0.1 );
    ...
    QColor Helper::checkBoxIndicatorColor( const QPalette& palette, bool mouseOver, bool active, qreal opacity, AnimationMode mode ) const
    {
        ...
        if( mode == AnimationHover )
        {
            ...
            const QColor focus( palette.color( QPalette::Highlight ) );
            const QColor hover( KColorUtils::mix( palette.color( QPalette::Highlight ), palette.color( QPalette::WindowText ), 0.2 ) );
            if( active ) color =  KColorUtils::mix( focus, hover, opacity );
            else color = KColorUtils::mix( color, hover, opacity );

        } else if( mouseOver ) {

            color = KColorUtils::mix( palette.color( QPalette::Highlight ), palette.color( QPalette::WindowText ), 0.2 );
    ...
    { return KColorUtils::mix( palette.color( QPalette::Window ), palette.color( QPalette::WindowText ), 0.1 ); }
