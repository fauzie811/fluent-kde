...
#include "fluentstyleconfigmodule.h"

#include <KPluginFactory>


K_PLUGIN_FACTORY(
    FluentStyleConfigFactory,
    registerPlugin<Fluent::ConfigurationModule>(QStringLiteral("kcmodule"));
)

#include "fluentstyleconfigmodule.moc"
