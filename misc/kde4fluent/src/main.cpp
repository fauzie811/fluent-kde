...
static const QString defaultLookAndFeelPackage = "org.kde.fluent.desktop";
...
void updateKdeGlobals()
{
    ...
    const QString widgetStyle = readConfigValue(lnfConfig, defaultLnfConfig, "KDE", "widgetStyle", "Fluent").toString();
    const QString colorScheme = readConfigValue(lnfConfig, defaultLnfConfig, "General", "ColorScheme", "Fluent").toString();
    const QString icons = readConfigValue(lnfConfig, defaultLnfConfig, "Icons", "Theme", "fluent").toString();
